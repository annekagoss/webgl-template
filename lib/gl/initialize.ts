...
export const assignUniforms = (uniforms: UniformSettings, uniformLocations: Record<string, WebGLUniformLocation>, gl: WebGLRenderingContext, time: number, mousePos?: Vector2, scrollPos?: Vector2) => {
		...
		switch (uniform.type) {
			...
			case UNIFORM_TYPE.VEC_2:
				...
				if (uniform.name === 'uScroll') {
					uniform.value = Object.values(scrollPos);
				}
